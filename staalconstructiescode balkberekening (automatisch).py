...
x = ["IPE100","IPE120","IPE140","IPE160","IPE180","IPE200","IPE220","IPE240","IPE270","IPE300","IPE330","IPE360","IPE400","IPE450","IPE500"]

for i in range(len(x)):
    profiel = x[i]
    #print(f"Nu wordt het {profiel}-profiel getest:")
    ...
    Tw = profile_data.TW
    Tf = profile_data.TF
    Cf = (float(b) - (float(Tw)) / 2)
    Cw = float(h) - (2 * float(Tf))
    ...
    if dsk == 1:
        ...
        Mcrd2 = float(Mcrd)*1e-6
        #print(f"De rekenwaarde van de momentweerstand capaciteit is {mrcd}")
    ...
    if UCm < 1:
        ...
        #print(f"De Unitycheck is: {UCm}, het {profiel}-profiel voldoet dus niet voor het maximale moment.")
        pass 
    ...
    if UCv < 1:
        ...
        #print(f"De Unitycheck is: {UCv}, het {profiel}-profiel voldoet dus niet voor de maximale verticale kracht.")
        pass 
    
    #print(" ")
    
    if UCm < 1 and UCv < 1:
        print(f"Beide unitychecks ({UCm}), ({UCv}) zijn kleiner dan 1, de balk met het profiel {profiel} voldoet dus.")
        break
    
    elif UCm >= 1:
        #print(f"De unitycheck voor het maximale moment ({UCm}) voldoet niet, er wordt een groter profiel geprobeerd.")
        #print(" ")
        pass
    
    else:
        #print(f"De unitycheck voor de maximale verticale kracht ({UCv}) voldoet niet, er wordt een groter profiel geprobeerd.")
        #print(" ")
        pass
